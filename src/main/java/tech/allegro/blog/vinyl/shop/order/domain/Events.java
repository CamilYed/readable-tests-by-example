...
public class Events {
  ...
  public static record OrderPaid(ClientId clientId,
                                 OrderId orderId,
                                 Instant when,
                                 Money amount,
                                 Delivery delivery
  ...
  public static record OrderPayFailedBecauseAlreadyPaid(OrderId orderId,
                                                        Instant when
  ) implements OrderDomainEvent {
  }

  public static record OrderPayFailedBecauseDifferentAmounts(OrderId orderId,
                                                             Instant when,
                                                             Money difference
  ) implements OrderDomainEvent {
  }
