...
class TestData {
  ...
  public static final ClientReputation STANDARD = ClientReputation.standard(new ClientId(CLIENT_ID))
  public static final ClientReputation VIP = ClientReputation.vip(new ClientId(CLIENT_ID))
